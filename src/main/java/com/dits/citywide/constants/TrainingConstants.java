...
public class TrainingConstants {
	...
	// Category Constants
	public static final String CATEGORY_NAME = "A Automation Testing Category";
	...
	public static final String CERTIFICATE_HEADING = " Certificate A";
	public static final String CERTIFICATE_NAME = "Automation Testing Certificate Name A";
	...
	// Course Constants
	// Add New Course data
	public static final String COURSE_NAME = "AI course for Beginners";
