...
public class OperationsHubConstant {
	...
	public static final String SITE_NAME = " M J New Jersy ";
...
//	public static final String TEMP_POST_ORDER_TEXT = "All officers must check parking lot hourly for suspicious activity.";
	...
	//======================Update Constant ====================================/
	public static final String SEARCH_SITE_NAME = "New York 121";
	public static final String UPDATE_SITE_NAME = "New York 122";
	public static final String UPDATE_AGENCY_BEAT = "1212, 333, 558, TESTB321 , 070707 - Main Beat";
	public static final String UPDATE_CALL_RESPONSE = "SERVICE HOURS";
	public static final String UPDATE_SERVICE_TIME = "02:00 - 10:00";
	public static final String UPDATE_REPORT_TIME = "07:00 PM";
	public static final String UPDATE_POLICE_AGENCIES = "TEST WEBDEV POLICE, POLICE ONE , QA Testing Agency";
	public static final String UPDATE_FIRE_AGENCIES = "Firewood agency";
	public static final String UPDATE_MEDICAL_AGENCIES = "Medical emergency";
	public static final String UPDATE_OTHER_AGENCIES = "OTHER WEBDEV, PLUMBER AGENCY";
	public static final String UPDATE_QUALIFICATIONS = "Baton, Driver License, ECD, Firearms, OC";
	public static final String UPDATE_ACCOUNT_MANAGER = "Tom Cruse";
	// -------- Update Site Address --------
	public static final String UPDATE_SITE_STREET_NUMBER = "789";
	public static final String UPDATE_SITE_STREET_NAME = "Broadway Avenue";
	public static final String UPDATE_SITE_CITY = "Newark";
	public static final String UPDATE_SITE_STATE = "NJ";
	public static final String UPDATE_SITE_ZIP_CODE = "07102";

	// ------- Update Geofencing -------------
	public static final String UPDATE_GEOFENCE_NAME = "Miles";
	public static final String UPDATE_GEOFENCE_ADDRESS = "250";

	// -------- Update Main Contact --------
	public static final String UPDATE_CONTACT_FIRST_NAME = "Ethan";
	public static final String UPDATE_CONTACT_LAST_NAME = "Williams";
	public static final String UPDATE_MAIN_CONTACT_PHONE = "6467891234";
	public static final String UPDATE_MOBILE = "9087654321";
	public static final String UPDATE_FAX = "2223334444";
	public static final String UPDATE_CONTACT_EMAIL = "ethan.williams@testmail.com";

	// -------- Update Site Contacts --------
	public static final String UPDATE_JOB_TITLE = "Supervisor";
	public static final String UPDATE_NEW_CONTACT_NAME = "Sophia";
	public static final String UPDATE_NEW_CONTACT_PHONE = "9873216540";
	
	// Update Property Access Details
	public static final String UPDATE_GATE_CODE = "GATE-4521";
	public static final String UPDATE_ALARM_ARM_CODE = "ALRM-5612";
	public static final String UPDATE_ALARM_UNARM_CODE = "ALRM-7843";
	public static final String UPDATE_ALARM_NOTES = "Main entrance, keypad located on left side of gate";
	public static final String UPDATE_LOCKBOX_CODE = "LBX-9910";
	public static final String UPDATE_LOCKBOX_NOTES = "Lockbox attached to fence near security office";
	
	// ---------------- Parking Enforcement Update ----------------
	public static final String UPDATE_TOW_COMPANY = "ExpressTow Solutions";
	public static final String UPDATE_TOW_PHONE = "(555) 987-6543";
	public static final String UPDATE_TOW_NOTES = "Towing service available during site hours only";
	public static final String UPDATE_PARKING_NOTES = "Ensure visitor vehicles are logged; violators will be reported to security";
	
	//------------------4th Update__Site Reports -----------------
	public static final String UPDATE_REPORT_INSTRUCTIONS = "This report provides a clear summary of activities, "
			+ "progress, and key findings for quick review and reference.";
	
	//----------------5th tab Overall Site Coverage -------------------
	public static final String UPDATE_OVERALL_COVERAGE ="Overall Site Coverage provides a comprehensive view of the "
			+ "entire site’s operational activities, security presence, and compliance with assigned tasks.";

	// ====== UPDATE Mobile CONSTANTS ======

	public static final String UPDATE_MOBILE_COVERAGE_NAME = "Updated Mobile Patrol 1";
	public static final String UPDATE_MOBILE_SERVICE_TYPE = "161";  // mobile option value
	public static final String UPDATE_MOBILE_BILLING_TYPE = "Monthly";
	public static final String UPDATE_MOBILE_BILLING_RATE = "175";
	public static final String UPDATE_HOLIDAY_RATE = "250";
	public static final String UPDATE_COVERAGE_END_DATE = "15/10/2029";

	public static final String UPDATE_MOBILE_DAY_START_TIME = "02:00am";
	public static final String UPDATE_MOBILE_DAY_END_TIME = "10:00pm";

	public static final String UPDATE_MOBILE_DAY_HITS = "6";
	public static final String UPDATE_MOBILE_SWING_HITS = "4";
	public static final String UPDATE_MOBILE_NIGHT_HITS = "3";
	
	// ===================== Stationary Coverage Update Flow Constants =====================
	public static final String UPDATE_STATIONARY_COVERAGE_NAME = "City Mall Security";
	public static final String UPDATE_STATIONARY_SERVICE_TYPE = "Banking Guarding (M)";
	public static final String UPDATE_STATIONARY_COVERAGE_END = "11/15/2025";
	public static final String UPDATE_STATIONARY_BILLING_TYPE = "Monthly";
	public static final String UPDATE_BILLING_RATE = "180";
	public static final String UPDATE_HOLIDAY_BILLING_RATE = "250";
	public static final String UPDATE_POST_RATE = "75";
	public static final String UPDATE_ALLOWANCE_RATE = "40";
	public static final String UPDATE_ALLOWANCE_TYPE = "57";

	public static final String UPDATE_STATIONARY_START_TIME = "06:00am";
	public static final String UPDATE_STATIONARY_END_TIME = "02:00pm";
	
	// Update Flow Site Area Constants
	public static final String UPDATE_SITE_AREA_NAME = "Parking Zone A";
	public static final String UPDATE_SITE_DOOR_GATE_COUNT = "6";
	public static final String UPDATE_SITE_AREA_NOTES = "Updated area for parking zone A with extended surveillance coverage.";

	public static final String UPDATE_SITE_LOCKUP_TIME = "11:30pm";
	public static final String UPDATE_SITE_UNLOCK_TIME = "6:00am";
