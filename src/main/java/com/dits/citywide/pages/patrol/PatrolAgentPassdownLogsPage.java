...
public class PatrolAgentPassdownLogsPage {
    ...
    private By btnView(String message) {
        String xpath = "//pre[normalize-space()='" + message + "']/../following-sibling::td//a[@class='cursor-pointer']";
    ...
    public By btnScanImage(String message) {
        String xpath = "//pre[normalize-space()='" + message + "']/../following-sibling::td//a[@class='c-cursor-pointer']";
        return By.xpath(xpath);
    }
    ...
    public PatrolAgentPassdownLogsPage(WebDriver driver) {
        this.driver = driver;
