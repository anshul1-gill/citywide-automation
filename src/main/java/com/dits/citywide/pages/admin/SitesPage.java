...
//	private By tabViewQRcode = By.cssSelector("#rc-tabs-1-tab-4");
	...
	private By inputSiteName = By.xpath("//input[@name='site_name']");
	private By dropdownAgencybeat = By.xpath("(//span[@role='combobox'])[1]");
	private By dropdownAssignOfficer = By.xpath("(//span[@role='combobox'])[2]");
	private By callresponse = By.cssSelector("#call_response_only");
	private By selectStartingpoint = By.xpath("//input[@id='service_starting_time']");
	private By selectendingpoint = By.xpath("//input[@id='service_end_time']");
	...
	private By reporttime = By.xpath("//input[@type='time']");
	private By clientEmail = By.xpath("//input[@id='reply_to']");
	private By dropdownpoliceAgencies = By.xpath("(//span[@class='select2-selection select2-selection--multiple'])[3]");
	private By dropdownFireAgencies = By.xpath("(//span[@class='select2-selection select2-selection--multiple'])[4]");
	private By dropdownmedicAgencies = By.xpath("(//span[@class='select2-selection select2-selection--multiple'])[5]");
	private By dropdownotheragencies = By.xpath("(//span[@class='select2-selection select2-selection--multiple'])[6]");
	private By dropdownSiteQualifications = By
			.xpath("(//span[@class='select2-selection select2-selection--multiple'])[7]");
	private By dropdownAccoountmanager = By
			.xpath("(//span[@class='select2-selection select2-selection--multiple'])[8]");
	...
	private By dropdownStationaryservicetype = By
			.xpath("//label[normalize-space(text())='Service Type']/following-sibling::select");
...
//	}
	...
	public void fillAddAssignmentForm(String assignmentName, String template, String coverageType,
		...
		// DEBUG: Print all available options in the coverage dropdown
		List<WebElement> options = dropdown.findElements(By.tagName("option"));
		System.out.println("Available coverage type options:");
		for (WebElement opt : options) {
			System.out.println("[COVERAGE] '" + opt.getText() + "'");
		}

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement option = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath(".//option[normalize-space(.)='" + coverageType.trim() + "']")));
		option.click();
		Thread.sleep(3000);
...
//		            .until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("ul.select2-results__options")));
	...
	public void fillGeneralDetails(String siteName, List<String> agencyBeat,List<String> AssignOfficer , String callResponse, String startingPoint,
			String endingPoint, boolean isStationary, boolean isMobile, boolean isPayPostRate, boolean isAutoReport,
			boolean isPdfReport, String reportTime, String clientEmailID, List<String> policeAgencies,
			List<String> fireAgencies, List<String> medicAgencies, List<String> otherAgencies,
			List<String> siteQualifications, List<String> accountManagers) throws InterruptedException {
...
//		elementUtils.doSelectByValue(callresponse, callResponse); 
		selectMultipleOptions(dropdownAgencybeat, agencyBeat);
		Thread.sleep(2000);
		selectMultipleOptions(dropdownAssignOfficer, AssignOfficer);
		elementUtils.doSelectByValue(callresponse, callResponse);
		Thread.sleep(2000);
		elementUtils.sendKeysUsingJavaScript(selectStartingpoint, startingPoint, Constants.DEFAULT_WAIT);
		Thread.sleep(2000);
	...
	public void fillPropertyAccessDetails(String gateCode, String alarmArm, String alarmUnarm, String alarmNotes,
			boolean hasLockBox, String lockBoxCode, String lockBoxNotes) {
	...
	public void fillParkingEnforcementDetails(String towingCompanyName, String towingCompanyPhone, boolean hasTowing,
			String towingNotes, boolean hasParkingEnforcement, String parkingNotes) {
	...
	public void fillMobileCoverageDetails(String coverageName, String serviceTypeValue, String billingTypemob,
			String billingRate, String holidayRate, String coverageEndDate, String dayStartTime, String dayEndTime,
			String dayHits, String swingHits, String nightHits, String dayNotes, String swingNotes, String nightNotes,
			boolean copyTimesToAll, boolean copyHitsToAll) {
		...
		elementUtils
				.waitForElementVisible(By.xpath("//option[@value='" + serviceTypeValue + "']"), Constants.DEFAULT_WAIT)
				.click();
	...
	public void fillStationaryCoverageDetails(String coverageName, String serviceTypeValue, String coverageEndDate,
			String billingtypestat, String billingRate, String holidayRate, String postRate, String allowanceRate,
			String allowanceTypeValue, String startTime, String endTime, String dayNotes, String swingNotes,
			String nightNotes, boolean copyTimesToAll) throws InterruptedException {

		// Click Add Stationary Coverage
		elementUtils.doClickWithActionsAndWait(btnAddStationaryCoverage, Constants.DEFAULT_WAIT);

		// Enter Coverage Name
		elementUtils.waitForElementVisible(txtinputStationaryCoveragename, Constants.DEFAULT_WAIT)
				.sendKeys(coverageName);
		Thread.sleep(5000);
		// Select Service Type
...
//		            .perform();
		...
		if (allowanceRate != null && !allowanceRate.isEmpty()) {
			...
			elementUtils.waitForElementVisible(By.xpath("//option[@value='" + allowanceTypeValue + "']"),
		...
		elementUtils.waitForElementVisible(textStationarySwingCoverageNotes, Constants.DEFAULT_WAIT)
				.sendKeys(swingNotes);
		elementUtils.waitForElementVisible(textStationaryNightCoverageNotes, Constants.DEFAULT_WAIT)
				.sendKeys(nightNotes);
	}

	public void fillSiteAreaDetails(String areaName, String doorGateCount, String areaNotes, String lockupTime,
			String unlockTime, boolean copyTimeToAll) {
...
//
	...
	public void fillSiteDocPaymentTerms(String firstName, String lastName, String companyName, String displayName,
			String phone, String mobile, String fax, String email, String terms, String billingCycle,
			String billingStartDate, String invoiceNumber, boolean autoSelectBillingCycle, boolean Togglehours,
			String streetNumber, String streetName, String city, String state, String zipCode, String country) {
