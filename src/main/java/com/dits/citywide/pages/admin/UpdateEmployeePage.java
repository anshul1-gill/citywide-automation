...
// 1. Personal Information
	...
	private By deleteUserProfilePicture = By.xpath("//span[@class='anticon anticon-close clear-image']");
	...
	private By dropdownGender = By.xpath("//input[@id='Personal Information_gender']");
...
// 8. References
	...
	public void clickDeleteUserProfilePicture() {
		elementUtils.doClickWithActionsAndWait(deleteUserProfilePicture, Constants.DEFAULT_WAIT);
	}
...
// 1. Personal Information
	public void fillPersonalInformation(String firstName, String middleName, String lastName, String gender,
		...
		elementUtils.waitForElementVisible(txtboxFirstName, Constants.SHORT_TIME_OUT_WAIT);
		elementUtils.clearTextBoxWithActions(txtboxFirstName);
		elementUtils.doActionsSendKeys(txtboxFirstName, firstName);
		
		elementUtils.waitForElementVisible(txtboxMiddleName, Constants.SHORT_TIME_OUT_WAIT).clear();
		elementUtils.clearTextBoxWithActions(txtboxMiddleName);
		elementUtils.doActionsSendKeys(txtboxMiddleName, middleName);
		elementUtils.waitForElementVisible(txtboxLastName, Constants.SHORT_TIME_OUT_WAIT);
		elementUtils.clearTextBoxWithActions(txtboxLastName);
		elementUtils.doActionsSendKeys(txtboxLastName, lastName);
