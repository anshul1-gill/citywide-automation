...
public class AddFieldAgentEmployeeTest extends BaseTest {
	...
	public void addNewEmployeeFieldAgentTest() throws InterruptedException {
		...
		addEmployeePage.fillPersonalInformation(HRManagementConstants.FIRST_NAME, HRManagementConstants.MIDDLE_NAME,
				...
				HRManagementConstants.SOCIAL_SECURITY_NUMBER, HRManagementConstants.ROLE_FIELD,
				HRManagementConstants.RANK, HRManagementConstants.ETHNIC_CODE, primaryEmail, secondaryEmail,
