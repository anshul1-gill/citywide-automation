...
public class FieldAgentMyReportsTest extends BaseTest {
	...
	public void myReportsFieldAgentTest() throws InterruptedException {
		...
		// softAssert.assertEquals(fieldAgentReportsPage.getArriveDateTime(),
		...
		// softAssert.assertEquals(fieldAgentReportsPage.getDepartDateTime(),
		// expectedDeparture,
		...
		fieldAgentReportsPage.uploadFile(OperationsHubConstant.REPORT_PHOTO_VIDEO_LINK,
		...
		Thread.sleep(2000);
		fieldAgentReportsPage.addOfficerReportEntry(prop.getProperty("url"),
		...
		Thread.sleep(3000); // Wait for page to load after last report update
		fieldAgentReportsPage.clickSubmitReports();
		// fieldAgentReportsPage.clickOkButton();
		// softAssert.assertEquals(fieldAgentReportsPage.getNoDataFoundText(),
		// FieldAgentConstants.NO_DATA_FOUND_TEXT,
