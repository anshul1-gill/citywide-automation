...
public class FieldAgentAddFieldInterviewTest extends BaseTest {
	...
	public void AddFieldInterviewTest() throws InterruptedException {
		...
		softAssert.assertTrue(fieldAgentFieldInterviewPage.isClearButtonDisplayed(), "Clear Button is not visisble");
		fieldAgentFieldInterviewPage.fillBasicDetails(FieldAgentConstants.FIELD_INTERVIEW_SITE_NUMBER,
				FieldAgentConstants.FIELD_INTERVIEW_CALL_ID,
				FieldAgentConstants.FIELD_INTERVIEW_INTERVIEW_DATE_TIME,
				FieldAgentConstants.FIELD_INTERVIEW_ACTIVITY_CODE, FieldAgentConstants.FIELD_INTERVIEW_LAST_NAME,
				FieldAgentConstants.FIELD_INTERVIEW_MIDDLE_NAME, FieldAgentConstants.FIELD_INTERVIEW_FIRST_NAME,
				FieldAgentConstants.FIELD_INTERVIEW_NICKNAME, FieldAgentConstants.FIELD_INTERVIEW_PHONE_NUMBER,
				FieldAgentConstants.FIELD_INTERVIEW_DL_ID_NUMBER, FieldAgentConstants.FIELD_INTERVIEW_DL_ID_STATE);
				
		fieldAgentFieldInterviewPage.fillAddressDetails(FieldAgentConstants.FIELD_INTERVIEW_ADDRESS_STREET_NUM,
				FieldAgentConstants.FIELD_INTERVIEW_ADDRESS_STREET_NAME,
				FieldAgentConstants.FIELD_INTERVIEW_ADDRESS_UNIT, FieldAgentConstants.FIELD_INTERVIEW_ADDRESS_CITY,
				FieldAgentConstants.FIELD_INTERVIEW_ADDRESS_STATE, FieldAgentConstants.FIELD_INTERVIEW_ADDRESS_ZIP);
		...
		fieldAgentFieldInterviewPage.fillResidenceAddressDetails(
				...
				FieldAgentConstants.FIELD_INTERVIEW_RESIDENCE_UNIT, FieldAgentConstants.FIELD_INTERVIEW_RESIDENCE_CITY,
				FieldAgentConstants.FIELD_INTERVIEW_RESIDENCE_STATE, FieldAgentConstants.FIELD_INTERVIEW_RESIDENCE_ZIP);
				Thread.sleep(5000);
		...
		fieldAgentFieldInterviewPage.fillCompanionDetails(FieldAgentConstants.FIELD_INTERVIEW_COMPANION_NAME,
				...
				FieldAgentConstants.FIELD_INTERVIEW_COMPANION_HAIR, FieldAgentConstants.FIELD_INTERVIEW_COMPANION_EYES,
		...
		fieldAgentFieldInterviewPage
				.fillTrespassAdvisalImages(FieldAgentConstants.FIELD_INTERVIEW_INTERVIEW_IMAGE_PATH);
		...
		softAssert.assertTrue(fieldAgentFieldInterviewPage.getOfficerName().contains(prop.getProperty("employeeID")));
		softAssert.assertTrue(fieldAgentFieldInterviewPage.getSiteName().contains(FieldAgentConstants.FIELD_INTERVIEW_SITE_NUMBER));
